...
CATEGORIES: Dict[str, LayerCategory] = {
    ...
    'photo': LayerCategory(
        id='photo',
        name_en='Aerial Photos',
        name_ja='年代別の写真'
    ),
    'elevation': LayerCategory(
        id='elevation',
        name_en='Elevation & Terrain',
        name_ja='標高・土地の凹凸'
    ),
    'landuse': LayerCategory(
        id='landuse',
        name_en='Land Formation & Land Use',
        name_ja='土地の成り立ち・土地利用'
    ),
    'reference': LayerCategory(
        id='reference',
        name_en='Reference Points & Geomagnetism',
        name_ja='基準点・地磁気・地殻変動'
    ),
    'disaster_eq': LayerCategory(
        id='disaster_eq',
        name_en='Recent Disasters - Earthquakes',
        name_ja='近年の災害 - 地震'
    ),
    'disaster_weather': LayerCategory(
        id='disaster_weather',
        name_en='Recent Disasters - Weather',
        name_ja='近年の災害 - 台風・豪雨等'
    ),
    'disaster_volcano': LayerCategory(
        id='disaster_volcano',
        name_en='Recent Disasters - Volcanoes',
        name_ja='近年の災害 - 火山'
    ),
    'other': LayerCategory(
        id='other',
